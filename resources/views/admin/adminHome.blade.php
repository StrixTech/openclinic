                    ...
                    <div class="card counter-box @settings('darkMode') bg-silver @else white @endsettings r-5 p-3">
                        <div class="p-4">
                            <div class="float-right">
                                <span class="icon icon-note-list @settings('darkMode') @else text-light-blue @endsettings s-48"></span>
                            </div>
                            <div class="counter-title @settings('darkMode') @else text-light-blue @endsettings">Number of staff</div>
